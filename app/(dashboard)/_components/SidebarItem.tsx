...
export default function SidebarItem({icon: Icon, label, href}: SidebarItemProps   ) {
    ...
    //pathname es la url actual
    //href es la url del item
  ...
  return (
    <button
        ...
        isActive && "text-sky-700 bg-sky-200/20 hover:bg-sky-200/20 hover:text-sky-700")} //cn es de shadcn sirve para concatenar clases
    > 
